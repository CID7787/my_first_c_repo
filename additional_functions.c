...
char *errors_sting_arr[17] = { "no error", "positive overflow", "negative overflow", "underflow", "division by zero", "exponentiation of zero to zero", 
                            "undefined behavior", "square root of negative number", "positive infinity", "negative infinity", "return real part",
                            "null pointer", "quite NaN", "signaling NaN", "incompatible", "attempt to get root of the number", "memory limit excess" };
