...
void vector_exponentiation_test(void){
  unsigned int f_pos_inf_ui = 0b01111111100000000000000000000000, f_neg_inf_ui = 0b11111111100000000000000000000000, ui_f_pos_nan = 0b01111111110000100110000010000000, ui_f_neg_nan = 0b11111111110000100110000010000000, ui_max_fl = 0b01111111011111111111111111111111, ui_min_fl = 0b00000000100000000000000000000000;
    ...
    printf("\n\n\n\n\n");
    vec_char = vector_exponentiation(vec_char, vec_char);
    vec_uchar = vector_exponentiation(vec_uchar, vec_uchar);
    vec_int = vector_exponentiation(vec_int, vec_int);
    vec_uint = vector_exponentiation(vec_uint, vec_uint);
    vec_lint = vector_exponentiation(vec_lint, vec_lint);
    vec_luint = vector_exponentiation(vec_luint, vec_luint);
    vec_float = vector_exponentiation(vec_float, vec_float);
    vec_double = vector_exponentiation(vec_double, vec_double);
    v = 0;
