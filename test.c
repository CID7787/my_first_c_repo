...
void vector_creation_test(void){
    ...
    unsigned int f_pos_inf_ui = 0x7f800000,
               f_neg_inf_ui = 0xff800000,
               ui_f_pos_nan = 0x7f8a23df, 
               ui_f_neg_nan = 0xff8a23df, 
               ui_max_fl    = 0x7f7fffff, 
               ui_min_fl    = 0x800000;
    float f_pos_inf = *(float*)&f_pos_inf_ui, 
                      f_neg_inf = *(float*)&f_neg_inf_ui,
                      f_pos_nan = *(float*)&ui_f_pos_nan, 
                      f_neg_nan = *(float*)&ui_f_neg_nan, 
                      f_max     = *(float*)&ui_max_fl, 
                      f_min     = *(float*)&ui_min_fl;
    long unsigned int d_pos_inf_lui = 0x7ff0000000000000, 
                      d_neg_inf_lui = 0xfff0000000000000,
                      lui_d_pos_nan = 0x7ffabc1349cd3332, 
                      lui_d_neg_nan = 0xfffabc1349cd3332, 
                      lui_max_d     = 0x7fefffffffffffff, 
                      lui_min_d     = 0x10000000000000;
    double d_pos_inf = *(double*)&d_pos_inf_lui, 
                       d_neg_inf = *(double*)&d_neg_inf_lui, 
                       d_pos_nan = *(double*)&lui_d_pos_nan, 
                       d_neg_nan = *(double*)&lui_d_neg_nan, 
                       d_max     = *(double*)&lui_max_d, 
                       d_min     = *(double*)&lui_min_d;
...
void vector_addition_test(void){
    ...
    printf("\n\n\n\n\n");
    vec_char = vector_addition(vec_char, vec_char);
    vec_uchar = vector_addition(vec_uchar, vec_uchar);
    vec_int = vector_addition(vec_int, vec_int);
    vec_uint = vector_addition(vec_uint, vec_uint);
    vec_lint = vector_addition(vec_lint, vec_lint);
    vec_luint = vector_addition(vec_luint, vec_luint);
    vec_float = vector_addition(vec_float, vec_float);
    vec_double = vector_addition(vec_double, vec_double);
    v = 0;
    while(v < vec_char.n){
      printf("\nvec_char.elements.b1.i[%d] = %d\n", v, vec_char.elements.b1.i[v]); // 00000010 + 11111110+
      v++;
