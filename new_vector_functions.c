        ...
        switch(b_type){
            ...
            case INT64:
                ...
                switch(a_type){
                    ...
                    case UINT32:  r.elements.ui32[i] = exp_uint32_to_uint64(a.elements.ui32[i], val.ui64, r.err); break;
                    case UINT64:  r.elements.ui64[i] = exp_uint64_to_uint64(a.elements.ui64[i], val.ui64, r.err); break;
                    case INT8:    r.elements.i8  [i] = exp_int8_to_int64   (a.elements.i8  [i], val.i64 , r.err); break;
                    case INT32:   r.elements.i32 [i] = exp_int32_to_int64  (a.elements.i32 [i], val.i64 , r.err); break;
                    case INT64:   r.elements.i64 [i] = exp_int64_to_int64  (a.elements.i64 [i], val.i64 , r.err); break;
                    case FLOAT32: r.elements.f32 [i] = exp_float_to_int64 ((fbits){ .f = a.elements.f32[i] }, val.i64, r.err); break;
                    case FLOAT64: r.elements.f32 [i] = exp_double_to_int64((dbits){ .d = a.elements.f64[i] }, val.i64, r.err);
                }    
            break;
            case FLOAT32:
                switch(a_type){
