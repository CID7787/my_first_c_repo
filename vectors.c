...
int main() {
  ...
  void* v0 = vector_creation(UINT, 0, (unsigned int[]){1, 0});
  void* v1 = vector_creation(UINT, 0, (unsigned int[]){1, 0});
  void* v2 = vector_creation(UINT, 0, (unsigned int[]){1, 0});
  void* v3 = vector_creation(UINT, 0, (unsigned int[]){1, 0});
  goto defer_continue;
    defer:
    free(v0);
    free(v1);
